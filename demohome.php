...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="demoform.php" class="w3-bar-item w3-button w3-right w3-mobile">Signup</a>
    <a href="demologin.php" class="w3-bar-item w3-button w3-right  w3-mobile">Login</a>
  </div>
...
<p class="w3-text-grey">Email: snehithbejawada6@gmail.com</p>
    ...
    <div class="w3-third w3-center w3-padding-64">
      <i class="fa fa-phone fa-5x fa-pull-center" style="font-size:160px" aria-hidden="true"></i>
    </div>
  </div>
</div>
<!-- Footer -->
